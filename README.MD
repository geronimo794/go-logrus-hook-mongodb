...
## Planned Update
1. **Async Feature**: Create async feature for logging process
1. **Process Timeout**: Add process timeout feature for logging process
1. **Context Setting**: Create input context for logging process
